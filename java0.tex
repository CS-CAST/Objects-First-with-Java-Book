...
Defining Person objects, the programmer may want to use common person related qualities such as: age, last name, first name, and whether the person is still a student. Consequently, the \mintinline{Java}{class Person} will be created with the corresponding data types.
...
\begin{tcolorbox}[enhanced,breakable, before upper={\let\clearpage\relax}, width=6in,center upper,
