...
System.out.println(a);
\end{minted}
\begin{tabu} to 120mm { | X[l] | X[c] |  X[c] | X[c]  | X[l] | X[c] | X[c] | X[c] |  }
  \hline
  \textbf{It.\#}  & \emph{i} & \emph{j} & \emph{a} & \textbf{It.\#}  & \emph{i} & \emph{j} & \emph{a}  \\
  \hline
  \emph{it 0}  &   &  &  &  \emph{it 5}  &  &   &   \\
  \hline
  \emph{it 1}  &   &  &   & \emph{it 6}  &  &   &   \\
...
\noindent
Consider the following code and answer the following questions \emph{\textbf{before}} filling in the table:
\begin{itemize}
\item What will the final output of \emph{k} be?
\item Why?
\item Looking at the for loops, how would you justify your assertion?
\end{itemize}
...
\begin{tabu} to 120mm { | X[l] | X[c] |  X[c] | X[c]  | X[c] | X[l] | X[c] | X[c] |  X[c] | X[c] | }
  ...
  \textbf{It.\#}  & \emph{i} & \emph{j} & \emph{k} & \emph{a} & \textbf{It.\#}  & \emph{i} & \emph{j} & \emph{k} & \emph{a}  \\
  \hline
  \emph{it 0}  &   &  &  &  &  \emph{it 16}  &  &   &  &  \\
  \hline
  \emph{it 1}  &   &  &  &  &  \emph{it 17}  &  &   &  &  \\
  \hline
  \emph{it 2}  &   &  &  &  &  \emph{it 18}  &  &   &  &  \\
  \hline
  \emph{it 3}  &   &  &  &  &  \emph{it 19}  &  &   &  &  \\
  \hline
  \emph{it 4}  &   &  &  &  &  \emph{it 20}  &  &   &  &  \\
  \hline
  \emph{it 5}  &   &  &  &  &  \emph{it 21}  &  &   &  &  \\
  \hline   
  \emph{it 6}  &   &  &  &  &  \emph{it 22}  &  &   &  &  \\
  \hline
  \emph{it 7}  &   &  &  &  &  \emph{it 23}  &  &   &  &  \\
  \hline
  \emph{it 8}  &   &  &  &  &  \emph{it 24}  &  &   &  &  \\
  \hline
  \emph{it 9}  &   &  &  &  &  \emph{it 25}  &  &   &  &  \\
  \hline
  \emph{it 10}  &   &  &  &  &  \emph{it 26}  &  &   &  &  \\
  \hline
  \emph{it 11}  &   &  &  &  &  \emph{it 27}  &  &   &  &  \\
  \hline
  \emph{it 12}  &   &  &  &  &  \emph{it 28}  &  &   &  &  \\
  \hline
  \emph{it 13}  &   &  &  &  &  \emph{it 29}  &  &   &  &  \\
  \hline
  \emph{it 14}  &   &  &  &  &  \emph{it 30}  &  &   &  &  \\
  \hline
  \emph{it 15}  &   &  &  &  &  \emph{\textbf{Final}}  &  &   &  &  \\
  \hline
...
\end{verbatim}
\noindent \textbf{Practice 6.}\\
\emph{Imagine} - you have been given 200 cinder blocks to wall off a flower bed - each measuring 1 ft. \\
The flower bed must have a minimum width and length of at least 1 ft. \footnote{Assume a rectangular flower bed. Perimeter is the sum of all sides. Area is width multiplied by length.}\\
Design an algorithm to:
\begin{itemize}
\item Print all possible combinations of width, length, and area
\item Print the greatest possible area at the completion of the function
\end{itemize}
\textbf{Write your algorithm here. Label and explain the major components.}
...
\begin{itemize}
\item Design an algorithm using \emph{nested} \emph{\textbf{for}} loops to determine where the two trains intersect. 
